...
while fica==1:
    if cargo == 'a':
        ...
        if atividade == 1:
            ...
            Cli_ID = raw_input ("Digite o código do cliente*.: ")
            ...
            for row in results:
                e = row[1]
                print e
            Fil_ID = raw_input("Digite um código para o filme.: ")
...
##          Pesquisa da variável busca na coluna Fil_nome da tabela filme
        ...
        if atividade == 1:
            ...
            for row in results:
                e = row[1]
                print e
            busca = raw_input ("Digite o nome do funcionário que deseja alterar os dados.: ")
            ...
            for row in results:
                e = row[1]
                print e
            busca = raw_input ("Digite o nome do funcionário que deseja excluir.: ")
            ...
            sql = "select * from clientes" 
            cursor.execute(sql)
            print 'Os usuários inseridos no sistema são.: '
            results = cursor.fetchall()
            for row in results:
                e = row[1]
                print e
